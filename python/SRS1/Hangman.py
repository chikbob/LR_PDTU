...
def main():
    ...
    global length
    global play_game
    words_to_guess = ["вогнегасник", "калинка", "бат", "радість", "кольчуга", "перука", "алтабас", "кульбаба",
                      "складка", "барометр", "автохром", "градусник", "асфальт", "купа", "сорока", "колгоспник",
                      "лавочник", "светр", "павич", "коляска"]
...
def play_loop():
    ...
    if play_game == "т" or play_game == "так" or play_game == "Так" or play_game == "ТАК" or play_game == "y" or play_game == "Y":
        main()
    else:
        print("Дякую за гру!")
        exit()
